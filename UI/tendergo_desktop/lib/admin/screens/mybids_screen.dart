...
class MyBidsScreen extends StatefulWidget {
  ...
  const MyBidsScreen({super.key, required BidService bidService, this.onBack})
...
class _MyBidsScreenState extends State<MyBidsScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          const SizedBox(
            width: 24,
          ), // Malo veći razmak na desktopu sa desne ivice
        ],
      ),
  ...
  Widget _buildBody(ColorScheme colorScheme) {
    ...
    // ISPRAVLJENO: Uklonjen RefreshIndicator i dodato desktop centriranje sa BoxConstraints
    return Center(
      child: Container(
        constraints: const BoxConstraints(
          maxWidth: 800,
        ), // Optimalna širina za pregled lista na desktopu
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ), // Desktop uvijek prikazuje status u istom redu
              ],
            ),
            ...
            Divider(
              height: 14,
              thickness:
                  1, // Popravljeno: debljina usklađena sa visinom prostora
            ...
            // ── price & actions row ──────────────────────────────────────────
            // Na desktopu spajamo cijenu i akcije u jedan horizontalni red radi uštede prostora
            Row(
              ...
              children: [
                ...
                // Akcije (Zeleni izvještaj, Rate ili Cancel)
