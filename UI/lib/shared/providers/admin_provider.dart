...
class AdminProvider {
  ...
  Future<ApiResponse> getCurrentUser() => authService.getCurrentUser();

  Future<ApiResponse> getAllUsers() => adminService.getAllUsers();
  ...
  Future<ApiResponse> unbanUser(String id) => adminService.unbanUser(id);
